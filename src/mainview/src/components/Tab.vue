<template>
  ...
  >
    ...
    >
      <path
        fill-rule="evenodd"
        d="M 15.299438 0c-4.970563 0-9 4.029437-9 9v15.981598c.048695 2.331788-.428313 4.284404-1.431024 5.85785C3.865703 32.412894 2.242899 33.466411.000001 34h15.299437V0Z"
      />
    </svg>
    ...
    >
      ...
      <span
        class="block w-full truncate text-left font-medium text-gray-700 group-focus:text-black"
      >
        {{ name }}
      </span>
      <span
        ...
        tabindex="0"
        class="outline-hidden w-4 h-4 flex-none text-xs bg-transparent hover:bg-gray-200 focus:bg-gray-300 rounded-full flex justify-center items-center"
      >
    ...
    >
      <path
        fill-rule="evenodd"
        d="M0 0c4.970563 0 9 4.029437 9 9v15.981598c-.048695 2.331788.428313 4.284404 1.431024 5.85785C11.433735 32.412894 13.056539 33.466411 15.299437 34H0V0Z"
      />
    </svg>
  </button>
</template>
